          ...
          $designation = $getGlobal[0]->designation;
            ...
            if($result){
               ...
               $message ='
                ...
                $response=array(
                //  "verified"=>"N",
                  "Result"=>array("email"=>$email,"participant_Type"=>"International","company_name"=>$company_name,"visitor_name"=>$visitor_name,"designation"=>$designation,"otp"=>$otp,"registration_id"=>$registration_id,"visitor_id"=>$visitor_id),
