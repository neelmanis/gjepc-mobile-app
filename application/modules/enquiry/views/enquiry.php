				...
				<tbody>
				  ...
				  ?>
					 <tr>
						...
						<!--<a class="btn btn-danger btn-xs" href="<?php echo base_url()."enquiry/delete_details/".$row['id']; ?>" title="Delete" id="delete" onClick="return confirmDelete();"><i class="fa fa-trash-o"></i></a>-->
                        </td>
					 </tr>
                       <?php } } ?>
				</tbody>
