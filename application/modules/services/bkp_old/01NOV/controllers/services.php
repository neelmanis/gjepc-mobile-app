...
class Services extends MX_Controller {
	...
	function fortnightly()
		{ 
			$json = file_get_contents('php://input');
			$obj = json_decode($json,True);
			$strResponse=$this->mdl_services->fortnightly();
		...
		{ 
			$json = file_get_contents('php://input');
			$obj = json_decode($json,True);
			$strResponse=$this->mdl_services->patrika();
	...
	function exhibitorList()
	{
		...
		{ 
			...
			$strResponse=$this->mdl_services->circularMember($year);
		...
		{ 
			...
			$strResponse=$this->mdl_services->circularGov($year);
