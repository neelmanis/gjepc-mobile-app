...
<div class="row justify-content-between page-titles">
  <div class="col-auto align-self-center">
	...
	<ol class="breadcrumb">
        <li class="btn btn-inline-block btn-primary mr-2"><a href="<?php echo base_url();?>tickets/add">Create Onsite Request</a></li>
    </ol>
	<?php } ?>
  </div>
    ...
    <form class="form-material" id='form-filter'>
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <select name="vendor_statuses" id="vendor_statuses" class="form-control" >
                    <option value=""></option>
                    <?php if($vendor_statuses !=="NA"){
                      foreach($vendor_statuses as $cat){ ?>
                      <option value="<?php echo $cat->id; ?>"><?php echo $cat->name; ?></option>
                    <?php } } ?>
                </select>
            </div>
