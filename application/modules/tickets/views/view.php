		...
		<div class="card">
			<div class="card-body">
				<div class="form-group row">
						<label for="example-text-input" class="col-sm-12 col-form-label"><strong>ISSUE</strong></label>
						<select class="form-control" name="issue_id" id="issue_id">                            
							<option value="">SELECT ISSUE</option>
							<?php foreach($issue as $i){ ?>
							<option value="<?php echo $i->id; ?>" <?php echo  $i->id == $onspot_visitor[0]->issue_id ? 'selected' : ''; ?>><?php echo strtoupper($i->issue_name); ?></option>
							<?php } ?>
						</select>                    
					</div>	
				<div class="form-group row">
					...
					<?php } else  { ?>
						<div class="form-group row">
							...
							<div class="col-sm-12">
								...
								<option value="">SELECT STATUS</option>
									<?php foreach($statuses as $val){ ?>
										<option value="<?php echo $val->id; ?>" <?php if($val->id == $onspot_visitor[0]->vendor_status_id){ echo 'selected'; }?>><?php echo strtoupper($val->name); ?></option>
									<?php } ?>
								</select>	
								<label for="statuses" generated="true" class="error"></label>
							</div>                        
...
.ppWrp:before {content:'';position:absolute;top: -4px;left: 0px;width: 8px;height: 8px;background: #00ff2b;border-radius: 100px; z-index: 46;}
</STYLE>
